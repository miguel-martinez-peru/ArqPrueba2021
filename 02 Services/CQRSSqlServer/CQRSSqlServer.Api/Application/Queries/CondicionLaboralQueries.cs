...
namespace CQRSSqlServer.Api.Application.Queries
{
    public class CondicionLaboralQueries : ICondicionLaboralQueries
    {
        ...
        public async Task<PaginatedItemsResponse<CondicionLaboralResponseDto>> Listar(CondicionLaboralRequestDto request)
        {
            ...
            using (var connection = new SqlConnection(_connectionString))
            {
                ...
                return new PaginatedItemsResponse<CondicionLaboralResponseDto>(0, 0, count, rpta);
            }
        }
