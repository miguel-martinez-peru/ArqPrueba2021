...
namespace CQRSSqlServer.Api.Controllers
{
    ...
    public class DocenteController : BaseController
    {
        ...
        [HttpGet("")]
        [ProducesResponseType(typeof(PaginatedItemsResponse<DocenteResponseDto>), StatusCodes.Status200OK)]
        ...
        public async Task<IActionResult> ListarDocentes([FromQuery] PaginatedItemsRequest<DocenteRequestDto> peticion)
        {
            //valida
