...
{
    public class UnitOfWork : Domain.AggregatesModel.IUnitOfWork, IDisposable
    {
        ...
        public UnitOfWork(AcademicoContext context)
        {
            _context = context;
        }
        ...
        public AcademicoContext Context
        {
            get { return _context; }
        }
