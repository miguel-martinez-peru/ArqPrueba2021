...
{
    public class AuthorizationHeaderPolicyProvider : DefaultAuthorizationPolicyProvider
    {
        private readonly AuthorizationOptions _options;

        public AuthorizationHeaderPolicyProvider(IOptions<AuthorizationOptions> options) : base(options)
        {
